...
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.display.TextDisplayMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.DonkeyMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.cuboid.MagmaCubeMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.cuboid.SlimeMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.golem.IronGolemMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.golem.ShulkerMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.golem.SnowGolemMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.horse.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.minecart.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.monster.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.monster.piglin.PiglinBruteMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.monster.piglin.PiglinMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.monster.raider.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.monster.skeleton.SkeletonMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.monster.skeleton.StrayMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.monster.skeleton.WitherSkeletonMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.monster.zombie.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.passive.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.tameable.CatMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.tameable.ParrotMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.tameable.WolfMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.villager.VillagerMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.villager.WanderingTraderMeta;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.mobs.water.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.other.*;
import dev.ckateptb.minecraft.jyraf.packet.entity.meta.projectile.*;
