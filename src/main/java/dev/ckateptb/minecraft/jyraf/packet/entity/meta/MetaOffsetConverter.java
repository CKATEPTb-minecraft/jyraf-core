// This class is generated by MinestomDataGenerator. Do not edit manually.
...
public final class MetaOffsetConverter {
    ...
    public static final class EntityMetaOffsets {
        public static byte airTicksOffset() {
            int protocolVersion = Jyraf.getPlugin().getPacketApi().getServerManager().getVersion().getProtocolVersion();
