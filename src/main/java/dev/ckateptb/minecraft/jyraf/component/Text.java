...
@UtilityClass
public class Text {
    private ComponentSerializer SERIALIZER = Runtime.version().version().get(0) < 17 ?
            new MineDownComponentSerializer() :
            new InkyComponentSerializer();

    public @NotNull Component of(@NotNull String string, @NotNull String... replacements) {
    ...
    public @NotNull String of(@NotNull Component component) {
        Objects.requireNonNull(component);
        return Text.SERIALIZER.serialize(component);
    }

    public void setGlobalComponentSerializer(@NotNull ComponentSerializer serializer) {
